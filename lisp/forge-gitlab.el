              ...
              (lambda (cb &optional v)
                ...
                (let-alist val
                  (cond
                   ...
                   ((not .assignees) (forge--fetch-assignees  repo cb))
                   ((not .forks)     (forge--fetch-forks      repo cb))
                   ((not .labels)    (forge--fetch-labels     repo cb))
                   ((not .issues)    (forge--fetch-issues     repo cb until))
                   ((not .pullreqs)  (forge--fetch-pullreqs   repo cb until))
                   (t
