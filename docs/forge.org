...
#+SUBTITLE: for version 0.1.0 (v0.1.0-184-gc1a5db6+1)
...
#+TEXINFO: @noindent
This manual is for Forge version 0.1.0 (v0.1.0-184-gc1a5db6+1).
...
The following commands list notifications and topics in dedicated
buffers:
