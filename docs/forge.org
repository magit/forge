...
#+SUBTITLE: for version 0.1.0 (v0.1.0-300-ga38c14ec+1)
...
#+TEXINFO: @noindent
This manual is for Forge version 0.1.0 (v0.1.0-300-ga38c14ec+1).
...
- Key ' c f, forge-fork
  ...
  Currently this only supports github.com and gitlab.com.
