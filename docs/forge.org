...
#+SUBTITLE: for version 0.1.0 (v0.1.0-87-g5037813+1)
...
#+TEXINFO: @noindent
This manual is for Forge version 0.1.0 (v0.1.0-87-g5037813+1).
...
The commands that pull forge data are available from the same
transient prefix command (~magit-pull~ on ~F~) that is used to pull
Git data.
